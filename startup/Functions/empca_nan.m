...
% 
%   [...] = EMPCA(A) calculates all the components.
% 
...
for comp = 1:ncomps % for each component
    ...
    for iter = 1:maxiters % repeat until u does not change or too many iterations
        ...
        % M-step with weights for NaN handling
